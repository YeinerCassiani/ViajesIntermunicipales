...
public class panelAdminClientes extends javax.swing.JPanel {
    ...
    public void llenarTabla(){
        cnx.conectar();
        limpiarTabla();
        usuario.addAll(cnx.consultarUsuario("Cliente"));
    ...
    private void initComponents() {
        ...
        tblCliente.setFont(new java.awt.Font("Roboto", 1, 10)); // NOI18N
        ...
        tblCliente.setMaximumSize(new java.awt.Dimension(1565540, 3424540));
    ...
    private void btnCrearMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCrearMouseClicked
        ...
        if (cnx.verificarUsuario(txtDocumento.getText())) {
            ...
            boolean correcto = cnx.ingresarUSuario(txtDocumento.getText(), txtNombre.getText() + " " + txtApellido.getText(), txtContrasena.getText(), txtTelefono.getText(), txtCorreo.getText(), txtUsuario.getText() ,"Cliente");
            if (correcto){
                llenarTabla();
    ...
    private void btnEditarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditarMouseClicked
        if (cnx.editarUSuario(txtDocumento.getText(), txtNombre.getText() , txtApellido.getText(), txtContrasena.getText(), txtTelefono.getText(), txtCorreo.getText(), txtUsuario.getText() ,"Cliente", usuario.get(indiceArray).getId_usuario())){
    ...
    private void tblClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblClienteMouseClicked
        indiceTabla = Integer.parseInt(tabla.getValueAt(tblCliente.getSelectedRow(), 0).toString()) - 1; 
        for (int i = 0; i < usuario.size(); i++) {
